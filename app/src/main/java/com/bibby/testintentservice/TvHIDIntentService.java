...
public class TvHIDIntentService extends IntentService {

    private final static String TAG = TvHIDIntentService.class.getSimpleName();
    private int i = 0;
     ...
     */
    public TvHIDIntentService(){
        super("TvHIDIntentService");
    }
     ...
     */
    public TvHIDIntentService(String name) {
        super(name);
